package com.abhinavdev.supergallery.ui.activities
...
import com.abhinavdev.supergallery.adapters.ImageAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun scanForImage() {
        val list = imageRepository.fetchAllImages()
        mainViewModel.setImageList(list)
    }
